...
const points = [
  {
    icon: ReceiptText,
    text: "Track bills, rent, and renewals before they're due",
  },
  {
    icon: CalendarClock,
    text: "Stay ahead of maintenance and seasonal upkeep",
  },
  {
    icon: FileText,
    text: "Keep documents, receipts, and warranties in one vault",
  },
  { icon: ShieldCheck, text: "A clear view of what needs you next" },
];
